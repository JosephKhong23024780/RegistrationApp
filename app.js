...
app.get('/login', (req, res) => {
    ...
    res.render('login', {
        ...
        errors: req.flash('error') // Retrieve error messages from the sessin and pass them to the view
    });
});
...
//******** TO DO: Insert code for dashboard route to render dashboard page for users. ********//
app.get('/dashboard', checkAuthenticated, (req, res) => {
    res.render('dashboard', { user: req.session.user });
});

//******** TO DO: Insert code for admin route to render dashboard page for admin. ********//
